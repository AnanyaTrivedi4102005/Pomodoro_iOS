...
class LeafView: UIView {
    ...
    private struct Constants {
        ...
        static var timerTextSizeTimerMode: UIFont {
            ...
            switch modelScreen {
            case .iPhone14, .iPhone14_Pro, .iPhone14_Pro_Max: return UIFont(name: fontName, size: 60)!
        ...
        static var timerTextSizeStandByMode: UIFont {
            let modelScreen = DeviceConstants.deviceModelScreen()
            switch modelScreen {
            case .iPhone14, .iPhone14_Pro, .iPhone14_Pro_Max: return UIFont(name: fontName, size: 115)!
        ...
        static var timerNameTextSize: UIFont {
            let modelScreen = DeviceConstants.deviceModelScreen()
            switch modelScreen {
            case .iPhone14, .iPhone14_Pro, .iPhone14_Pro_Max: return UIFont(name: fontName, size: 30)!
